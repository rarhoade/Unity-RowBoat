...
public class PlayerInput : MonoBehaviour {
    ...
    public float maxStamina = 105;
    private float stamina = 105;
    private bool pulledThisFrame = false;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            //rightBagette.transform.localEulerAngles = Vector3.Lerp(rightBagette.transform.localEulerAngles, new Vector3(-5, min_RO, 70), 0.1f);
            //leftBagette.transform.localEulerAngles = Vector3.Lerp(leftBagette.transform.localEulerAngles, new Vector3(5, min_LO, 70), 0.1f);
        }
        //float avgY = (-1 * leftBagette.transform.localEulerAngles.y + rightBagette.transform.localEulerAngles.y) / 2f;
        //body.transform.localEulerAngles = Vector3.Lerp(body.transform.localEulerAngles, new Vector3(body.transform.localEulerAngles.x, body.transform.localEulerAngles.y, avgY / range_RO * 20f), 0.1F);
